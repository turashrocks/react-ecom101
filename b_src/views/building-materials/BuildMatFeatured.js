...
// import AwsSliderStyles from '../../../node_modules/react-awesome-slider/dist/style.css';
import '../../styles/slider.css';

export default class BuildMatFeatured extends Component {
    render() {
        return (
            <>
            <div className="build-mat">
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <h1 classNameName="display-4 center">Buiilding Materials</h1>
                    </div>
                </div>
                <div className="container">
